...
import "./CodeInitiate.css";
import axios from "axios";

class CodeInitiate extends Component{
    ...
    componentDidMount(){
        ...
        axios.put('https://tr-episode-companion-default-rtdb.firebaseio.com/artifacts.json',artifacts)
             .catch(err=>{
                alert('Network Error');
                console.log(err);
             })
