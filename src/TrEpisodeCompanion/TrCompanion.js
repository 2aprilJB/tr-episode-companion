    ...
    render(){
        return(
            <div className="MainContainer">
                ...
                {this.props.loggedIn[0]?<TrEpisode setPublicCoordsForProxies ={this.props.setPublicCoordsForProxies} activeProxyZone = {this.props.activeProxyZone} activeTeamCoords = {this.props.activeTeamCoords} storeOptions = {this.props.storeOptions} setActiveCoords = {this.props.setActiveCoords} baseUrl = {this.props.baseUrl} loggedIn = {this.props.loggedIn} logoutHandler = {this.props.logoutHandler} activeTeam = {this.props.loggedIn[1]}/>:
